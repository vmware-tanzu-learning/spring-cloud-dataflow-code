...
public class BatchApplicationTests {
	...
	/**
	 * This is the typical example of testing that a Spring Batch job can run
	 * successfully. Recall that spring-batch-tests dependency was in the Maven POM.
	 * Run the tests in this file - they should pass. You should see the 5 users
	 * listed on the console log output with their names in upper case.
	 */
	@Test
